...
const Header = () => {
  ...
  return (
    <header className="bg-white dark:bg-slate-800 dark:text-zinc-50 shadow-md dark:shadow-slate-600 md:px-4 md:flex md:justify-between items-center sticky top-0 z-50 font-poppins py-4">
      ...
      <nav
        className={`bg-white dark:bg-slate-800 gap-5 py-5 md:py-0 md:flex md:flex-row items-center transition-all duration-300 absolute md:static w-full md:w-auto md:shadow-none shadow-lg  ${
