...
const Header = () => {
  ...
  return (
    <header className="bg-white dark:bg-slate-800 dark:text-zinc-50 shadow-md dark:shadow-slate-600 md:px-4 md:flex md:justify-between items-center sticky top-0 font-poppins">
      <div className="p-2">
